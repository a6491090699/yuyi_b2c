...
<ul>
<li<?php if($action=='login') { ?> class="on"<?php } ?>
><a href="?action=login&forward=<?php echo $_forward;?>">帐号登录</a></li>
<?php if($could_sms) { ?><li<?php if($action=='sms') { ?> class="on"<?php } ?>
><a href="?action=sms&forward=<?php echo $_forward;?>">短信登录</a></li><?php } ?>
<?php if($could_scan) { ?><li<?php if($action=='scan') { ?> class="on"<?php } ?>
><a href="?action=scan&forward=<?php echo $_forward;?>">扫码登录</a></li><?php } ?>
</ul>
</div>
