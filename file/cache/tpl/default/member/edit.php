...
<tr>
<td class="tl">昵称</td>
<td class="tr"><?php echo $_passport;?><?php if($_passport == $_username) { ?>&nbsp;&nbsp;<a href="send.php?action=passport" class="b">[修改]</a><?php } ?>
</td>
</tr>
<tr>
<td class="tl">邮件</td>
<td class="tr"><?php echo $_email;?><?php if($vemail) { ?>&nbsp;&nbsp;<img src="image/v_email.gif" title="已认证" align="absmiddle"/><?php } ?>
<?php if($DT['mail_type'] != 'close') { ?>&nbsp;&nbsp;<a href="send.php?action=email" class="b">[修改]</a><?php } ?>
</td>
</tr>
<?php if($vmobile) { ?>
<tr>
<td class="tl">手机</td>
<td class="tr"><input type="hidden" name="post[mobile]" id="mobile" value="<?php echo $mobile;?>"/><?php echo $mobile;?>&nbsp;&nbsp;<img src="image/v_mobile.gif" title="已认证" align="absmiddle"/><?php if($DT['sms']) { ?>&nbsp;&nbsp;<a href="send.php?action=mobile" class="b">[修改]</a><?php } ?>
</td>
</tr>
<?php } else { ?>
<tr>
...
<td class="tr"><input type="text" size="20" name="post[gzh]" id="gzh" value="<?php echo $gzh;?>"/><?php if(in_array('gzh', $_E)) { ?>&nbsp;<?php if(isset($_U['gzh'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?>
<?php } ?>
</td>
</tr>
<tr>
<td class="tl">公众号二维码</td>
<td class="tr"><input name="post[gzhqr]" type="text" size="60" id="gzhqr" value="<?php echo $gzhqr;?>" readonly/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>, 128, 128, Dd('gzhqr').value, true, 'gzhqr');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview(Dd('gzhqr').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('gzhqr').value='';" class="jt">[删除]</span>
<?php if(in_array('gzhqr', $_E)) { ?>&nbsp;<?php if(isset($_U['gzhqr'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?>
<?php } ?>
</td>
</tr>
</tbody>
