...
<li<?php if($stepid==1) { ?> class="on"<?php } ?>
><i>1</i>注册验证</li>
<li<?php if($stepid==2) { ?> class="on"<?php } ?>
><i>2</i>填写资料</li>
<li<?php if($stepid==3) { ?> class="on"<?php } ?>
><b>&nbsp;</b>注册成功</li>
<li style="width:90px;">&nbsp;</li>
</ul>
</div>
...
<tr>
<td class="tl"></td>
<td class="tr">&nbsp;&nbsp;<a href="javascript:;" class="b" onclick="Msend();" id="send">发送邮箱</a><span id="sendok" class="f_r f_green"></span></td>
<td class="tt"><span id="dsend" class="f_red"></span></td>
</tr>
<tr>
...
);"/><label for="g_<?php echo $k;?>"> <?php echo $GROUP[$k]['groupname'];?></label>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
<?php } } ?>
...
<td class="tr"><input type="text" class="input-user" name="post[passport]" id="passport" placeholder="会员昵称，支持中文" onblur="Dvalidator('passport');" autocomplete="off"<?php if($passport) { ?> value="<?php echo $passport;?>" readonly<?php } ?>
/></td>
<td class="tt">
...
<td class="tr"><input type="password" class="input-pass" name="post[password]" id="password" placeholder="登录密码" onblur="Dvalidator('password');" autocomplete="off"<?php if($password) { ?> value="<?php echo $password;?>" readonly<?php } ?>
/></td>
<td class="tt">
...
<td class="tr"><input type="password" class="input-pass" name="post[cpassword]" id="cpassword" placeholder="再输入一遍登录密码" onblur="Dvalidator('cpassword');" autocomplete="off"<?php if($password) { ?> value="<?php echo $password;?>" readonly<?php } ?>
/></td>
<td class="tt">
