...
<tr>
<td class="tl">上次登录</td>
<td class="tr"><?php echo timetodate($logintime, 5);?><?php if($DT['login_log']==2) { ?>&nbsp;&nbsp;<a href="record.php?action=login" class="b">登录记录</a><?php } ?>
</td>
</tr>
<tr>
<td class="tl">注册时间</td>
...
<tr>
<td class="tl">邮件认证</td>
<td class="tr"><a href="validate.php?action=email"><?php if($vemail) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?>
</a></td>
</tr>
<?php } ?>
<?php if($MOD['vmobile']) { ?>
<tr>
<td class="tl">手机认证</td>
<td class="tr"><a href="validate.php?action=mobile"><?php if($vmobile) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?>
</a></td>
</tr>
<?php } ?>
<?php if($MOD['vbank']) { ?>
<tr>
<td class="tl">银行认证</td>
<td class="tr"><a href="validate.php?action=bank"><?php if($vbank) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?>
</a></td>
</tr>
<?php } ?>
...
<tr>
<td class="tl">实名认证</td>
<td class="tr"><a href="validate.php?action=truename"><?php if($vtruename) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?>
</a></td>
</tr>
<?php } ?>
<?php if($MOD['vcompany']) { ?>
<tr>
<td class="tl">公司认证</td>
<td class="tr"><a href="validate.php?action=company"><?php if($vcompany) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?>
</a></td>
</tr>
<?php } ?>
</table>
