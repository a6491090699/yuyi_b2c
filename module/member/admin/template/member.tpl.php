...
<input type="hidden" name="search" value="<?php echo $search == 2 ? 2 : 1;?>"/>
<table cellspacing="0" class="tb">
<tr>
<td><span class="f_r" style="line-height:24px;"><?php if($search) {?><a href="?moduleid=<?php echo $moduleid;?>&action=<?php echo $action;?>" class="t">返回</a><?php } else {?><a href="?moduleid=<?php echo $moduleid;?>&action=<?php echo $action;?>&search=2" class="t">高级</a><?php } ?></span>&nbsp;
